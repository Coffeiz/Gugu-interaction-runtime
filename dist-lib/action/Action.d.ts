...
export type Action = MoveAction | MoveGroupAction | TransferAction | SortAction | ResizeAction | LinkAction | ConnectionCreateAction | ConnectionDeleteAction | ConnectionCancelAction;
