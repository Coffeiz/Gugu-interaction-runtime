...
export declare function captureCollectionPresence(root: ParentNode, selector: string, key?: (element: HTMLElement) => string, ignore?: (element: HTMLElement) => boolean, scopeSurfaces?: readonly HTMLElement[], measurement?: LayoutMeasurement): CollectionPresenceSnapshot;
