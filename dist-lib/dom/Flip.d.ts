 ...
 */
export declare function captureRects(elements: HTMLElement[]): Map<HTMLElement, DOMRect>;
/**
...
export declare function playFlip(elements: HTMLElement[], before: Map<HTMLElement, DOMRect>, duration?: number, easing?: string): void;
